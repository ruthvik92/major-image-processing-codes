...
Courtesy OpenCv
This code can be sujected any kind of editions and distributions provided the names of
...
"""
import fnmatch #compare a single filename against a pattern and returns a boolean indicating
